...
cdevents-controller is a tiny web application made with Go
that showcases best practices of running microservices in Kubernetes.

cdevents-controller is used by CNCF projects like [Flux](https://github.com/fluxcd/flux2)
and [Flagger](https://github.com/fluxcd/flagger)
for end-to-end testing and workshops.

## Installing the Chart

The cdevents-controller charts are published to
[GitHub Container Registry](https://github.com/bradmccoydev/cdevents-controller/pkgs/container/charts%2Fcdevents-controller)
...
```console
$ helm upgrade -i my-release oci://ghcr.io/bradmccoydev/charts/cdevents-controller
```

To verify a chart with Cosign:

```console
$ cosign verify ghcr.io/bradmccoydev/charts/cdevents-controller:<VERSION>
```

Alternatively, you can install the chart from GitHub pages:

```console
$ helm repo add cdevents-controller https://bradmccoydev.github.io/cdevents-controller

$ helm upgrade -i my-release cdevents-controller/cdevents-controller
```

The command deploys cdevents-controller on the Kubernetes cluster in the default namespace.
...
The following tables lists the configurable parameters of the cdevents-controller chart and their default values.
...
| `image.repository`                | `bradmccoydev/cdevents-controller` | Image repository                                                                                                       |
...
| `service.grpcService`             | `cdevents-controller`              | gPRC service name                                                                                                      |
...
| `securityContext`                 | `{}`                   | The security context to be set on the cdevents-controller container                                                                |
...
```console
$ helm install my-release cdevents-controller/cdevents-controller \
...
```console
$ helm install my-release cdevents-controller/cdevents-controller -f values.yaml
```
